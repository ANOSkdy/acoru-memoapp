...
export default function PageEditor({
  ...
  const applyImageFileToBlock = (sourceBlockIndex: number, file: File) => {
    if (
    ...
    reader.onload = () => {
      ...
      handleImageUrlChange(sourceBlockIndex, value);
      setSaveError(null);
    };
          ...
          <div className="block-card" key={block.id}>
            ...
            {block.type === "divider" ? (
              ...
              <div className="block-image">
                ...
                <div className="block-row block-row--stacked">
                  <span className="block-label">画像を添付（2MB まで）</span>
                  <input
                  ...
                  />
                  <label
                    className="button button--ghost block-upload-button"
                    htmlFor={`image-file-${block.id}`}
                  >
                    画像をアップロード
                  </label>
                </div>
